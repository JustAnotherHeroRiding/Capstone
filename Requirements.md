...
- In the sidebar I should be able to search for usernames of other users and view their profiles
- I can check if it is a user, add some identified in the models so i can load the proper component, profile if it's a user and so on
